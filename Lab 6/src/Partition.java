/*  Java Class: Partition.java
    Author: Jin Choi & Henry Nguyen
    Class: CSCI 230
    Date: 4/11/2018
    Description: Partition class that handles the make cluster, find and union. has an internal counter variable to count the number of calls to find.
