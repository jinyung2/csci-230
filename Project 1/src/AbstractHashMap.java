/*  Java Class: AbstractHashMap.java
    Author: Jin Choi
    Class: CSCI 230
    Date: Mar 20, 2018
    Description: The abstract hash map class that links all the different hashing schemes together. Various methods and instance variables were added to compute the six different required outputs for the project.
...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
  ...
  protected int tableSize, totalProbe, numProbe, maxProbe, totalCluster, numCluster, maxCluster;//Additional instance variables used for implementing the report generation in the project. Added the variable to the AbstractHashMap class to be inherited by subclasses.
  ...
  protected abstract int reportTableSize();
  protected abstract double getAverageProbes();
  protected abstract int getMaxProbesWorstCase();
  protected abstract int getNumCluster();
  protected abstract double getAverageCluster();
  protected abstract int getLargestCluster();
  protected abstract void generateReport();
  protected abstract void setNumProbe(Integer n);
}
